...
public class btree_elem_upsert implements client_profile {
  ...
  // create a btree and insert 100 elements and repeat
  ...
  public boolean do_btree_test(client cli) throws Exception {
    ...
    for (long bkey = base; bkey < base + 100; bkey++) {
      ...
      fb = cli.next_ac.asyncBopUpsert(key, bkey, null /* eflag */,
                                      val,
